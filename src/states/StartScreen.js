export default class StartScreen extends Phaser.State {
    ...
    create() {
        ...
        this.startButton = this.game.add.button(this.game.world.centerX, 300, 'startButton', () => {
            this.game.state.start('game');
        }, this, 1, 1, 1);
        this.startButton.anchor.set(0.5);
        this.startButton.scale.setTo(.3, .3);

        this.highscoreButton = this.game.add.button(this.game.world.centerX, 425, 'highscoreButton', () => {
